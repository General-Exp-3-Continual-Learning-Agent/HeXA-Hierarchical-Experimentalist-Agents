...
# Level: down_to_earth
# Train seeds: 1–50, Val seeds: 51–100, batch_size=50, 20 epochs (1 step/epoch)
#
# Setup:
...
# Then:
#   sbatch examples/train/interphyre/slurm_train_7b_a100_2gpu_dte_1epoch.sh
# ─────────────────────────────────────────────────────────────────────────────
...
total_epochs=20
total_training_steps=20     # 50 train samples / batch_size 50 = 1 step/epoch
batch_size=50
