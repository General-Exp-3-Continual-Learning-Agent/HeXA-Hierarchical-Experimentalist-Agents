#!/bin/bash
#SBATCH --job-name=evolving_grpo_dte
...
#
# Pre-requisites:
#   1. FirstFiveTrajs available: SKILL-RL/FirstFiveTrajs/dte_epoch0_trajectories.jsonl
...
INIT_TRAJ_JSONL="$VERL_TOOL_DIR/SKILL-RL/FirstFiveTrajs/dte_epoch0_trajectories.jsonl"
SKILLRL_INIT_DIR="$VERL_TOOL_DIR/SKILL-RL/data/initial/$LEVEL"
SKILL_BANK_DIR="$VERL_TOOL_DIR/SKILL-RL/Skill_banks/evolving_grpo_dte"
DATA_DIR="$VERL_TOOL_DIR/data/interphyre_dte_evolving_continuous"
...
echo "================================================================"
echo "  Evolving Skill Bank + GRPO (continuous process) — down_to_earth"
...
run_name="interphyre-a100-1gpu-${model_pretty_name}-${rl_alg}-n${n}-b${batch_size}-t${temperature}-lr${lr}-evolving-dte"
