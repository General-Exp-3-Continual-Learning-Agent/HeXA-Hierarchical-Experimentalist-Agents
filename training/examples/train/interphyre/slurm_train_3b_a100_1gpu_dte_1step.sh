...
# Level: down_to_earth
# Train seeds: 1–50, Val seeds: 51–100, batch_size=50, 1 gradient step
#
# Setup:
...
# Then:
#   sbatch examples/train/interphyre/slurm_train_3b_a100_1gpu_dte_1step.sh
# ─────────────────────────────────────────────────────────────────────────────
...
total_epochs=1
total_training_steps=1      # single gradient step
batch_size=50
