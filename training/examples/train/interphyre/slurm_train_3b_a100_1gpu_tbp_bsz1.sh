...
# batch_size=1 (1 seed per gradient update), 20 epochs = 1000 steps
#
# Setup:
#   python examples/data_preprocess/interphyre_data.py \
#     --output_dir data/interphyre_tbp_s1_50 \
...
DATA_DIR="$VERL_TOOL_DIR/data/interphyre_tbp_s1_50"
...
echo "================================================================"
echo "  Interphyre 3B Training on 1x A100 80GB"
...
if [ ! -f "$train_data" ]; then
    ...
    echo "               --output_dir data/interphyre_tbp_s1_50 \\"
...
run_name="interphyre-a100-1gpu-${model_pretty_name}-${rl_alg}-n${n}-b${batch_size}-t${temperature}-lr${lr}"
