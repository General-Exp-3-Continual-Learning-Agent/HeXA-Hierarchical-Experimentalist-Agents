...
CHECKPOINT="/scratch4/workspace/svaidyanatha_umass_edu-phyre/checkpoints/interphyre/interphyre-a100-1gpu-qwen_qwen2.5-3b-instruct-grpo-n4-b32-t1.0-lr1e-6/run17/global_step_74/actor/huggingface"
...
echo "================================================================"
echo "  Interphyre Eval — run17 checkpoint, down_to_earth, seeds 51-100"
