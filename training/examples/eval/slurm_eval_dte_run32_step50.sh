...
CHECKPOINT="/scratch4/workspace/svaidyanatha_umass_edu-phyre/checkpoints/interphyre/interphyre-a100-1gpu-qwen_qwen2.5-3b-instruct-grpo-n4-b1-t1.0-lr1e-6/run32/global_step_50/actor/huggingface"
...
OUTPUT="$VERL_TOOL_DIR/logs/eval/dte_run32_step50.jsonl"
echo "Eval output: $OUTPUT"

echo "================================================================"
echo "  Interphyre Eval — run32 step 50 (epoch 1), down_to_earth, seeds 51-100"
